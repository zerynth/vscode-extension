...
export function Init() {
    ...
    vscode.window.registerTreeDataProvider(
        'zerynth.panels.device_manager',
        zdm
    );

    vscode.commands.registerCommand('zerynth.panels.device_manager.addWorkspace', () => {
        z.addWorkspaceZDM();
    });

    vscode.commands.registerCommand('zerynth.panels.device_manager.addFleet', (item?) => {
        if(item!==undefined){
    ...
    vscode.commands.registerCommand('zerynth.panels.device_manager.lookDevice', async (item) => {
